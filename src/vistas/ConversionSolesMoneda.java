...
public class ConversionSolesMoneda extends JFrame {
	...
	public ConversionSolesMoneda() {
		...
		btnConvertir.setBounds(208, 195, 89, 23);
		contentPane.add(btnConvertir);

	}

	protected void reiniciar() {
		// Eliminamos los items del combo para de esta manera volverlo a
		// llenar y se añadan monedas nuevas en caso se hayan añadido
		// De esta manera podemos actualizar las monedass sin necesidad de cerrar y
		// abrir el frame
